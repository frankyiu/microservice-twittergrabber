...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    public TwitterKafkaConsumer(KafkaListenerEndpointRegistry kafkaListenerEndpointRegistry, KafkaAdminClient kafkaAdminClient, KafkaConsumerConfigData kafkaConsumerConfigData, KafkaConfigData kafkaConfigData, AvroToElasticModelTransformer avroToElasticModelTransformer, ElasticIndexClient<TwitterIndexModel> elasticIndexClient) {
    ...
    @EventListener
    public void onAppStarted(ApplicationStartedEvent e) {
    ...
    public void receive(@Payload List<TwitterAvroModel> messages,
        ...
        LOG.info("{} number of message received with keys {}, partition {} and offset {}, " +
        ...
        List<String> result = elasticIndexClient.save(elasticModels);
